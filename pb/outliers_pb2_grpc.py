...
import pb.outliers_pb2 as outliers__pb2
...
class OutliersStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Report = channel.unary_unary(
                '/pb.Outliers/Report',
                request_serializer=outliers__pb2.ReportType.SerializeToString,
                response_deserializer=outliers__pb2.ReportB.FromString,
                )
...
def add_OutliersServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Report': grpc.unary_unary_rpc_method_handler(
                    servicer.Report,
                    request_deserializer=outliers__pb2.ReportType.FromString,
                    response_serializer=outliers__pb2.ReportB.SerializeToString,
            ),
    }
...
class Outliers(object):
    ...
    def Report(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/pb.Outliers/Report',
            outliers__pb2.ReportType.SerializeToString,
            outliers__pb2.ReportB.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
